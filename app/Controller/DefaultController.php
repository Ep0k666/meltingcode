...
class DefaultController extends Controller
{
    ...
    * @return boolean|resource */
    ...
    public static function resize($file, $string = null, $width = 0, $height = 0, $proportional = false, $output = 'file', $delete_original = true, $use_linux_commands = false, $quality = 100)
    {
       if ($height <= 0 && $width <= 0)
           return false;
