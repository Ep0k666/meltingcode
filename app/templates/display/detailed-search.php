    ...
    <section id="search_box">
        <article id="detailed_search">
            ...
            <form method="POST" action="">
                ...
                <input type="text" id="tag_detailed" name="tag_detailed"
                       placeholder="Exemple : nom boutique, ville, secteur d'activité etc... "><br/>
                ...
                <div id="container_activity_check">
                    ...
                    <?php foreach ($activities as $activity) : ?>
                        ...
                        <div class="activity_at_check">
                            ...
                            <input type="checkbox" id="<?= $activity['category'] ?>" name="<?= $activity['name_id'] ?>"
                                   value="<?= $activity['id_catshops'] ?>">
