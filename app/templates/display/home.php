		  				...
		  				<div data-column='5' class="at-grid">
                            ...
                            <div class="at-column">
                                <div class="at-user">
                                    ...
                                    <div class="at-user__avatar"><img src="<?= $img ?>" alt="Malika Ould Ottmane"
                                                                      title="Malika Ould Ottmane"/></div>
                                    ...
                                    <ul class="at-social">
                                        ...
                                        <li class="at-social__item"><a
                                                href="https://fr.linkedin.com/in/malikaouldotmane">
                                                <svg viewBox="0 0 24 24" width="18" height="18"
                                                     xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="at-column">
                                <div class="at-user">
                                    ...
                                    <div class="at-user__avatar"><img src="<?= $img ?>" alt="Julie Mathieu"
                                                                      title="Julie Mathieu"/></div>
                                    ...
                                    <ul class="at-social">
                                        ...
                                        <li class="at-social__item"><a
                                                href="https://fr.linkedin.com/in/julie-mathieu-789569b9">
                                                <svg viewBox="0 0 24 24" width="18" height="18"
                                                     xmlns="http://www.w3.org/2000/svg">
                                                    <path d="<?= $path3 ?>" fill-rule="evenodd"></path>
                                                </svg>
                            ...
                            <div class="at-column">
                                <div class="at-user">
                                    ...
                                    <div class="at-user__avatar"><img src="<?= $img ?>" alt="Halima Lehain"
                                                                      title="Halima Lehain"/></div>
                            ...
                            <div class="at-column">
                                <div class="at-user">
                                    ...
                                    <div class="at-user__avatar"><img src="<?= $img ?>" alt="François-Xavier Roux"
                                                                      title="François-Xavier Roux"/></div>
                                    ...
                                    <ul class="at-social">
                                        ...
                                        <li class="at-social__item"><a
                                                href="https://fr.linkedin.com/in/francoisxavierroux">
                                                <svg viewBox="0 0 24 24" width="18" height="18"
                                                     xmlns="http://www.w3.org/2000/svg">
                                                    <path d="<?= $path3 ?>" fill-rule="evenodd"></path>
                                                </svg>
                            ...
                            <div class="at-column">
                                <div class="at-user">
                                    ...
                                    <div class="at-user__avatar"><img src="<?= $img ?>" alt="Steven Perini"
                                                                      title="Steven Perini"/></div>
