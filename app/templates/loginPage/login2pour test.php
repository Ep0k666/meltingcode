...
<div class="info"><a href="http://www.grandvincent-marion.fr" target="_blank"><p> Made with <i class="fa fa-heart"></i> by Marion Grandvincent </p></a></div>

<div class="content">
    <div class="container">
        <img class="bg-img" src="http://www.grandvincent-marion.fr/_codepen/bg.jpg" alt="">
        <div class="menu">
        ...
        <div class="connexion">
            ...
            <hr>
            <a href="http://www.grandvincent-marion.fr/" target="_blank"><h4>Forgot password?</h4></a>
        </div>
